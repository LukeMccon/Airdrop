...
See the [documentation home](README.md) for setup instructions and links by task.
This reference covers every setting, command, and extension API detail.
...
- Documentation: [Airdrop guides](README.md)
- Overview: [Modrinth](https://modrinth.com/plugin/airdrop)
