...
public enum MessageKey {
	...
	COMMANDS_HELP_PACKAGES("commands.help.packages", "{text}/airdrop packages{primary} — browse packages and view their items"),
	...
	ERROR_SKY_BLOCKED_SURFACE("errors.sky-blocked-surface",
			"Your location is below the highest surface ({material}) at Y: {y}. Move into open sky and try again."),
	ERROR_INVALID_TARGET("errors.invalid-target", "Could not resolve the drop location. Please try again."),
	...
	GUI_CATALOG_FREE("gui.catalog-free", "Free"),
	GUI_CATALOG_OPEN("gui.catalog-open", "Click to view items"),
	GUI_CATALOG_EMPTY("gui.catalog-empty", "No packages available with your permissions"),
	GUI_PACKAGE_REQUEST("gui.package-request", "Request: /airdrop {name}"),
	GUI_PACKAGE_AVAILABILITY("gui.package-availability", "Balance, cooldown, and server limits are checked when requesting"),
	GUI_PACKAGE_READ_ONLY("gui.package-read-only", "Read-only preview"),
	GUI_CLOSE("gui.close", "Close"),
	GUI_CATALOG_CHANGED("gui.catalog-changed", "Packages or permissions changed. Reopen the catalog to continue."),
	GUI_PACKAGE_OPEN_ERROR("gui.package-open-error", "Unable to open this package right now"),
